    ...
    <?php foreach ($list as $row) { ?>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tm-about-box-1">
                <a href="#"><img src="../back/uploads/<?php echo $row['logo']; ?>" width="150" height="150" alt="img" class="tm-about-box-1-img"></a>
                ...
                <!-- Add the button with a link to ajouterLivraison.php and passing the id as a parameter -->
                <a href="ajouterLivraison.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Acheter</a>
            </div>
            </br>
        </div>
    <?php } ?>
