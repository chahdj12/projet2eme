...
if (isset($_SESSION["username"])) {
	if ($_SESSION["role_user"] == "ADMIN_ROLE")
		header("location:../back/Utilisateurs.php.php");
	else if ($_SESSION["role_user"] == "USER_ROLE")
		header("location:index.php");
}
$con = mysqli_connect('localhost', 'root');
mysqli_select_db($con, 'utilisateur');
$username = "";
...
mysqli_select_db($conn, 'utilisateur');
	$sql = "Select * from utilisateurs where username = '" . $username . "'";
        if(!isset($_COOKIE["member_login"])) {
            $sql .= " AND password_user = '" . $password . "'";
	}
		...
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					...
					<div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">log In</h2></div>
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
				</div>				
			</div>
			<div class="form-main">
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group">
											...
											<input name="username" type="text" value="<?php if (isset($_COOKIE["member_login"])) {
