...
$mail->setFrom('noreply@users.com', 'no-reply');
...
$link='localhost/users/Views/front/verifierUtilisateur.php?email='.$email_user;
...
$mail->Body = 'Bonjour ' .$nom_user.' '.$prenom_user .',
                ...
                Cordialement.'.'
                <br><br>
               this message was sent from an unmonitored address . Please do not reply to this address.<br><br>Best regards,<br>Souleima';
