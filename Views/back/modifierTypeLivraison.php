...
if (
    isset($_POST["nom"])
    // Ajoutez d'autres champs en fonction de vos propriétés TypeLivraison
) {
    $nom = $_POST["nom"];
    // Récupérez les autres champs en fonction de vos propriétés TypeLivraison
    $id = $_POST["id"];

    $typeLivraison = new TypeLivraison($id, $nom);
    // Initialisez d'autres propriétés de TypeLivraison
                    ...
                    <div class="container mt-5">
                        <form method="post" action="" onsubmit="return validateForm()">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nom" name="nom" value="<?= $typeLivraison['nom'] ?>" required>
                            </div>
                            <!-- Ajoutez d'autres champs en fonction de vos propriétés TypeLivraison -->
