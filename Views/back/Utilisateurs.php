                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $item['nom_user'] ?>
                                            </td>
                                            <td>
                                                <?php echo $item['prenom_user'] ?>
                                            </td>
                                            <td>
                                                <?php echo $item['email_user'] ?>
                                            </td>
                                            <td>
                                                <?php echo $item['tel_user'] ?>
                                            </td>
                                            <td>
                                                <?php echo $item['adresse_user'] ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php echo $item['role_user'] ?>
                                            </td>

                                            <td>
                                            <td>
                                                <a href="approuverUser.php?id=<?php echo $item['id_user']; ?>" class="ico del">Approuver</a>
                                                <a href="supprimerUser.php?id=<?php echo $item['id_user'] ?>"> <i class="mdi mdi-delete">delete</i> </a>
