...
<body class="sb-nav-fixed">
    ...
    <tbody>
        <?php foreach ($tickets as $ticket) { ?>
            <tr>
                <td><?= $ticket['id'] ?></td>
                <td><?= $ticket['idReservation'] ?></td>
                <td><?= $ticket['matricule'] ?></td>
                <td><?= $ticket['prixTotale'] ?></td>
                <td>
                    <a href="modifierTicket.php?id=<?= $ticket['id'] ?>" class="btn btn-warning btn-sm">Modifier</a>
                    <a href="supprimerTicket.php?id=<?= $ticket['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce ticket ?')">Supprimer</a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
