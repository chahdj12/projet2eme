...
if (isset($_GET['id'])) {
    $ticket = $ticketC->getTicketById($_GET['id']);
}
...
if (
    ...
    $ticket = new Ticket($id, $idReservation, $matricule, $prixTotale);

    $ticketC->modifierTicket($ticket);
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Modifier Ticket</li>
                    </ol>
                    ...
                    <div class="container mt-5">
                        <form method="post" action="" onsubmit="return validateForm()">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="idReservation" name="idReservation" value="<?= $ticket['idReservation'] ?>" >
                            </div>
                            <div class="form-group">
                                <label for="matricule">Matricule</label>
                                <input type="text" class="form-control" id="matricule" name="matricule" value="<?= $ticket['matricule'] ?>" >
                            </div>
                            <div class="form-group">
                                <label for="prixTotale">Prix Totale</label>
                                <input type="number" class="form-control" id="prixTotale" name="prixTotale" value="<?= $ticket['prixTotale'] ?>" >
                            </div>

                            <button type="submit" class="btn btn-primary">Modifier</button>
                            <a href="tickets.php" class="btn btn-danger">Retour à la liste</a>
                        </form>
                    </div>
                </div>
            </main>
